...
module.exports = class RankCard {
    constructor() {
        ...
        this.textLevel = "Seviye {level}";
        this.textNeededXp = "{current}/{needed} for next rank";
        this.textReputation = "{reputation}";
    ...
    async toAttachment() {
        ...
        var grd = ctx.createLinearGradient(0, 0, 1080, 200);
        grd.addColorStop(0, "#FE924A");
        grd.addColorStop(1, "#FE0A3F");
        ...
        ctx.font = applyText(canvas, lvlText, 32, 170, "Arial");
        ...
        ctx.font = applyText(canvas, this.username, 45, 460, "Arial");
        ...
        if (this.addonRank) {
            ...
            ctx.font = applyText(canvas, "#" + this.rank, 45, 194, "Arial");
            ctx.fillText("#" + this.rank, canvas.width - 50 - 5, 80);
        }
        if (this.addonRankName) {
            ctx.textAlign = "left";
            ctx.fillStyle = this.colorRankName;
            ctx.font = applyText(canvas, this.rankName, 35, 690, "Arial");
        ...
        if (this.addonBadges) {
            ...
            for (let index = 0; index < badgeNames.length; index++) {
                ...
                if (!this[badge]) {
                    ...
                    ctx.textAlign = "center";
                    ctx.font = applyText(canvas, ".", 120, 50, "Arial");
        ...
        ctx.font = applyText(canvas, textXPEdited, 25, 690, "Arial");
        ctx.fillText(
            textXPEdited,
            50 + 240 + 45 + 5 + 690 / 2,
            80 + 45 + 15 + 30 + 90
