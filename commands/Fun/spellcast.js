...
module.exports = {
    ...
    usage: "spellcast",
    aliases: ["spellcast"],
    description: "Ses Kanalinda spellcast izlemenizi sağlar!",
    cooldown: 20,
            ...
            try {
                await fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
                        ...
                        body: JSON.stringify({
                            max_age: 86400,
                            max_uses: 0,
                            target_application_id: together.spellcast,
                            target_type: 2,
                            temporary: false,
                            validate: null,
                        }),
                ...
                return message.channel.send({
                    embeds: [Embed("success", message.author.tag, message.author.displayAvatarURL(), `[**spellcast Çagırmak için tıkla!**](${returnData.code})`)]
                });
