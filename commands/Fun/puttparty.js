...
module.exports = {
    ...
    usage: "puttparty",
    aliases: ["puttparty"],
    description: "Ses Kanalinda puttparty izlemenizi sağlar!",
    cooldown: 20,
            ...
            try {
                await fetch(`https://discord.com/api/v8/channels/${channel.id}/invites`, {
                        ...
                        body: JSON.stringify({
                            max_age: 86400,
                            max_uses: 0,
                            target_application_id: together.puttparty,
                            target_type: 2,
                            temporary: false,
                            validate: null,
                        }),
                ...
                return message.channel.send({
                    embeds: [Embed("success", message.author.tag, message.author.displayAvatarURL(), `[**puttparty Çagırmak için tıkla!**](${returnData.code})`)]
                });
