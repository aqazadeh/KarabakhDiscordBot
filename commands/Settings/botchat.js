            ...
            if (!args[0]) {
                return message.reply({
                    embeds: [new MessageEmbed()
                        ...
                        .setTitle(` **Please add a Method+Channel!**`)
            ...
            if (add_remove == "add") {
                if (client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
                    return message.reply({
                        embeds: [
                            ...
                            .setColor(ee.wrongcolor)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(` **This Channel is already a whitelisted Bot-Channel!**`)
                        ],
                    })
                }
                ...
                return message.reply({
                    embeds: [
                        ...
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle(`**The Channel \`${Channel.name}\` got added to the ${client.settings.get(guild.id, "djroles").length - 1} whitelisted Bot-Channels!**`)
                ...
                if (!client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
                    return message.reply({
                        embeds: [
                            ...
                            .setColor(ee.wrongcolor)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(` **This Channel is not a whitelisted Bot-Channel yet!**`)
                        ],
                    })
                }
                ...
                return message.reply({
                    embeds: [
                        ...
                        .setColor(ee.color)
                        .setFooter(ee.footertext, ee.footericon)
                        .setTitle(`**The Channel \`${Channel.name}\` got removed from the ${client.settings.get(guild.id, "djroles").length} whitelisted Bot-Channels!**`)
                        .addField(`🎧 **Bot-Channel${client.settings.get(guild.id, "botchannel").length > 1 ? "s": ""}:**`, `>>> ${djs}`, true)
                    ],
                })
            }
