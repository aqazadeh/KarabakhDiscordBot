                ...
                if (!args[0]) {
                    return message.reply({
                        embeds: [new MessageEmbed()
                            ...
                            .setTitle(` **Please add a __Method+Role__!**`)
                ...
                if (!["add", "remove"].includes(add_remove)) {
                    return message.reply({
                        embeds: [new MessageEmbed()
                            .setColor(ee.wrongcolor)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(` **Please add a __valid Method__+Role!**`)
                            .setDescription(`**Usage:**\n> \`${client.settings.get(message.guild.id, "prefix")}dj <add/remove> <@Role>\``)
                        ],
                    });
                }
                ...
                if (!Role) {
                    return message.reply({
                        embeds: [new MessageEmbed()
                            .setColor(ee.wrongcolor)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(` **Please add a Method+__Role__!**`)
                            .setDescription(`**Usage:**\n> \`${client.settings.get(message.guild.id, "prefix")}dj <add/remove> <@Role>\``)
                        ],
                    });
                }
                ...
                if (add_remove == "add") {
                    ...
                    return message.reply({
                        embeds: [
                            ...
                            .setColor(ee.color)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(`**The Role \`${Role.name}\` got added to the ${client.settings.get(guild.id, "djroles").length - 1} DJ-Roles!**`)
                    ...
                    if (!client.settings.get(guild.id, "djroles").includes(Role.id)) {
                        return message.reply({
                            embeds: [
                                ...
                                .setColor(ee.wrongcolor)
                                .setFooter(ee.footertext, ee.footericon)
                                .setTitle(` **This Role is not a DJ-ROLE yet!**`)
                            ],
                        })
                    }
                    ...
                    return message.reply({
                        embeds: [
                            ...
                            .setColor(ee.color)
                            .setFooter(ee.footertext, ee.footericon)
                            .setTitle(`**The Role \`${Role.name}\` got removed from the ${client.settings.get(guild.id, "djroles").length} DJ-Roles!**`)
                            .addField(`🎧 **DJ-Role${client.settings.get(guild.id, "djroles").length > 1 ? "s": ""}:**`, `>>> ${djs}`, true)
                        ],
                    })
                }
